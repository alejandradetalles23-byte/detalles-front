...
>
  <div class="max-w-7xl mx-auto">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16 px-4">
      <div class="col-span-1 md:col-span-2 space-y-6">
        {#if !instagramUrl}
          <div class="flex items-center gap-3">
            <div
              class="w-12 h-12 bg-gradient-to-br from-brand-red via-brand-orange to-brand-violet rounded-2xl flex items-center justify-center text-white font-bold text-xl shadow-lg"
            >
              AD
            </div>
            <span
        ...
        <div class="flex gap-4">
          ...
          {#if instagramUrl}
            <a
              ...
              class="w-12 h-12 rounded-full bg-neutral-800 flex items-center justify-center hover:bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-600 hover:text-white transition-all shadow-lg hover:scale-110 active:scale-95"
            >
          ...
          {#if whatsapp}
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              class="w-12 h-12 rounded-full bg-neutral-800 flex items-center justify-center hover:bg-green-500 hover:text-white transition-all shadow-lg hover:scale-110 active:scale-95"
            >
      ...
      <div class="space-y-6">
        ...
        <ul class="space-y-4">
          ...
          <li>
            <a
              href="/arreglos"
              class="hover:text-brand-orange transition-colors">Arreglos</a
            >
          </li>
          <li>
            <a
      ...
      <div class="space-y-6">
        <h4
          class="text-white font-bold uppercase tracking-widest text-sm underline decoration-brand-orange underline-offset-8 decoration-2 mb-8"
        >
          Contacto
        </h4>
        <ul class="space-y-6">
          ...
          <li>
            ...
            {#if whatsapp}
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                class="flex items-center gap-3 text-brand-orange font-black text-xl hover:scale-105 transition-transform origin-left"
              >
    ...
    <div
      class="pt-12 border-t border-neutral-800 flex flex-col md:flex-row justify-between items-center gap-6"
    >
      <p class="text-sm">
