...
<div class="max-w-7xl mx-auto px-4 md:px-12 py-16">
    <div class="mb-16 text-center">
        <h1 class="text-5xl font-black mb-4 font-serif text-neutral-900 leading-tight">Nuestras Categorías</h1>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {#each categoriesWithImage as cat}
                <a 
                    ...
                    class="group block bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 border border-neutral-100 transform hover:-translate-y-2"
                >
                    <div class="aspect-square bg-neutral-100 relative overflow-hidden">
                        ...
                        {:else}
                            <div class="w-full h-full flex flex-col items-center justify-center text-neutral-300 p-6 text-center">
                        ...
                        {/if}
                        <div class="absolute inset-0 bg-gradient-to-t from-neutral-900/80 via-neutral-900/20 to-transparent opacity-60 group-hover:opacity-80 transition-opacity"></div>
                        <div class="absolute bottom-0 left-0 w-full p-6 translate-y-2 group-hover:translate-y-0 transition-transform">
                            ...
                            <div class="flex items-center gap-2 mt-2 text-brand-orange opacity-0 group-hover:opacity-100 transition-opacity delay-100">
