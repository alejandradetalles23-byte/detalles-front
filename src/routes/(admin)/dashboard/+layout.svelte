...
<div class="min-h-screen bg-neutral-50 flex ">
  ...
  <aside class="w-64 bg-white border-r border-neutral-100 flex flex-col hidden md:flex ">
    <div class="p-8 border-b border-neutral-50 flex items-center gap-3">
        ...
        <span class="font-serif font-black text-lg text-neutral-900 leading-tight">Alejandra Detalles<br><span class="text-[9px] font-sans font-extrabold text-neutral-400 uppercase tracking-tighter">Panel de Administración</span></span>
    </div>

    <nav class="flex-grow p-6 space-y-2">
        <a href="/dashboard" class="flex items-center gap-3 p-3 rounded-xl hover:bg-neutral-50 font-bold text-neutral-600 hover:text-brand-violet transition-all">
        ...
        <a href="/dashboard/arreglos" class="flex items-center gap-3 p-3 rounded-xl hover:bg-neutral-50 font-bold text-neutral-600 hover:text-brand-violet transition-all">
        ...
        <a href="/dashboard/categorias" class="flex items-center gap-3 p-3 rounded-xl hover:bg-neutral-50 font-bold text-neutral-600 hover:text-brand-violet transition-all">
        ...
        <a href="/dashboard/perfil" class="flex items-center gap-3 p-3 rounded-xl hover:bg-neutral-50 font-bold text-neutral-600 hover:text-brand-violet transition-all">
        ...
        <a href="/dashboard/config" class="flex items-center gap-3 p-3 rounded-xl hover:bg-neutral-50 font-bold text-neutral-600 hover:text-brand-violet transition-all">
  ...
  <nav class="md:hidden fixed bottom-6 left-6 right-6 bg-white/80 backdrop-blur-xl border border-neutral-100 rounded-[2.5rem] shadow-2xl z-50 p-2 flex justify-around items-center ">
    ...
    <a href="/dashboard/arreglos" class="p-4 rounded-3xl text-neutral-400 hover:text-brand-violet transition-all">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14l-5-4.87 6.91-1.01L12 2z"/></svg>
    </a>
    <a href="/dashboard/categorias" class="p-4 rounded-3xl text-neutral-400 hover:text-brand-violet transition-all">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>
    </a>
    <a href="/dashboard/config" class="p-4 rounded-3xl text-neutral-400 hover:text-brand-violet transition-all">
         <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"/><circle cx="12" cy="12" r="3"/></svg>
    </a>
  </nav>
  ...
  <main class="flex-grow p-6 md:p-12 overflow-y-auto pb-32 md:pb-12">
    <header class="flex justify-between items-center mb-10 md:mb-12">
        <div class="flex items-center gap-4">
            <div class="md:hidden w-10 h-10 bg-brand-violet rounded-xl flex items-center justify-center text-white ring-4 ring-brand-violet/10">
            ...
            <div>
                <h2 class="text-2xl md:text-3xl font-black text-neutral-900 tracking-tight leading-none">Panel AD</h2>
